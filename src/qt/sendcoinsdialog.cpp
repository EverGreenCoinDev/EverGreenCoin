    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter an EverGreenCoin address (e.g. EdFwYw4Mo2Zq6CFM2yNJgXvE2DTJxgdBRX)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send EverGreenCoin"),
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid EverGreenCoin address"));
        }
        else
        {
