...
#
# To open a shell terminal in Ubuntu desktop press "CTRL + ALT + T" at the same time on your keyboard. Input or copy and paste the following command line (excluding the "#" at the beginning) to get this bash script and execute it:
